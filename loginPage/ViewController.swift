...
class ViewController: UIViewController {
    ...
    let haveAccountButton: UIButton = {
        let haveAccount = UIButton(type: .system)
            haveAccount.backgroundColor = .yellow
        let attributeTitle = NSAttributedString(string: "Don't have an account", attributes: [NSAttributedString.Key.backgroundColor: UIColor.white])
